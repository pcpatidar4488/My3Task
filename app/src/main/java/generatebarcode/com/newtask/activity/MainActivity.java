package generatebarcode.com.newtask.activity;
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // Toast.makeText(MainActivity.this, "Button 1 click", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MainActivity.this, generatebarcode.com.newtask.activity.FragmentZoomableActivity.class);
